...
- Могу ли иметь pet-проекты на стороне? Есть ли у компании свой мини-инкубатор проектов?

# Проект менеджер

- Кто оценивает мою работу и по каким критериям?
- Периодичность отчетности и ее форматы
- Пределы моей ответственности в принятии решений: кадровых, финансовых, продуктовых
- Вопросы, по которым я не могу самостоятельно принимать решения. Кто эти люди и как быстро они принимают решения.
- Проектная документация: стандарты и шаблоны, перечень must have документов.
- Кто основной инициатор изменений? Как часто? Есть ли процедуры утверждения изменений?

# Технологии

- Какой технический стек обычно используется в компании?
- Как вы используете системы контроля версий/исходного кода?
- Сколько окружений на проекте. Какая процедура выкатки кода на окружения. Кто ответственный. 
